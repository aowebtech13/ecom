...
export default function ParentLoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    setLoading(true);
    try {
      const response = await api.post('/v1/auth/parent/login', { email, password });
      ...
      <View style={[styles.container, { backgroundColor: palette.surface }]}>
        <View style={[styles.card, { backgroundColor: palette.card }]}>
          ...
          <View style={styles.demoContainer}>
            ...
            <ThemedText style={[styles.demoText, { color: palette.text }]}>📧 parent@example.com</ThemedText>
            <ThemedText style={[styles.demoText, { color: palette.text }]}>🔑 parent123</ThemedText>
          </View>
        </View>
      </View>
    </ScrollView>
